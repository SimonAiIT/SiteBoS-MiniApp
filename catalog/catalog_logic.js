 ...
 * - Parametri Navigazione Corretti (catId, prodId, vat).
 */
...
// ==========================================
// 4. LOAD CATALOG (CON GESTIONE BONUS)
// ==========================================
    ...
    categories.forEach((cat) => {
        ...
        subcats.forEach((prod) => {
            ...
            if (isRealProduct) {
                ...
                infoAreaTitle = `title="Modifica scheda"`;
            } else {
                // GHOST
...
// ==========================================
// 6. NAVIGATION (BLINDATA)
// ==========================================

window.goBack = () => {
    // Torna alla dashboard passando i parametri corretti
...
window.deleteProduct = async function(prodName, prodId) {
    const confirmText = t('confirm_delete_prod').replace('{name}', prodName);
