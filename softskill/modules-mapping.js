...
const MODULE_MAPPING = {
  ...
  modulo2: {
    ...
    targetSkills: ["RelazioniInterpersonali", "ComunicazioneEfficace", "Empatia", "GestioneDeiConflitti", "Leadership", "GestioneDelTeam", "SoddisfazioneDelCliente", "Negoziazione"]
  },
  ...
  modulo3: {
    ...
    targetSkills: ["ProblemSolving", "PensieroCritico", "DecisionMaking", "PianificazioneEOrganizzazione", "GestioneDelTempo", "Innovazione", "MenteAperta", "Adattabilita"]
  },
  ...
  modulo4: {
    ...
    targetSkills: ["EticaProfessionale", "Integrita", "Equita", "TematicheSociali", "DiversitaEInclusione", "ResponsabilitaSociale", "SicurezzaSulLavoro", "SicurezzaDigitale"]
  }
};
